...
Config.DevMode = true        -- โหมดนักพัฒนา (ให้เปลี่ยนเป็น false หากเปิดเซิร์ฟเวอร์จริง)
...
Config.SkinnableAnimals = {
    -- ใช้สำหรับกำหนดสัตว์ขนาดเล็กที่เมื่อแล่แล้วสามารถนำไปขายที่คนขายเนื้อได้ทันที โดยไม่จำเป็นต้องนำไปเพิ่มในตาราง CONFIG.ANIMALS อีก
    [989669666]   = {
        name = "Rat",
    ...
    -- สำหรับสัตว์ขนาดใหญ่ เมื่อคุณแล่เนื้อ (Skin) ระบบจะให้ไอเทมแก่คุณ หากคุณเคยเพิ่มสัตว์ชนิดนั้นไว้ในส่วนของ CONFIG.ANIMALS (ส่วนที่ใช้ขายซากสัตว์) 
    -- แล้วให้คัดลอกการตั้งค่าจากตรงนั้นมาวางที่นี่ได้เลยแต่ให้ลบบรรทัดที่เกี่ยวกับการให้เงิน (Money) และรางวัลอื่น ๆ ออกตามตัวอย่างที่แสดงไว้ด้านล่าง
